<%@ Page Title="Course-Details" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="course-details.aspx.cs" Inherits="comp2084_Lab_3.course_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:TextBox ID="txtTitle" runat="server" MaxLength="100" required />
    </div>
    <div class="form-group">
        <label for="txtCredits" class="col-sm-2">Credits:</label>
        <asp:TextBox ID="txtCredits" runat="server" Type="number" required />
    </div>
    <div class="form-group">
